...
/**
 * Created by Rain on 2016/7/18.
 */
public class VerifyCodeUtil {
    private static final long serialVersionUID = 3038623696184546092L;
    public static final int WIDTH = 102;//生成的图片的宽度
    ...
    public static void setBackGround(Graphics g) {
        // 设置颜色
        g.setColor(new Color(238,247,235));
        // 填充区域
   ...
   public static void drawRandomLine(Graphics g) {
    ...
    public static String drawRandomNum(Graphics2D g, String... createTypeFlag) {
        ...
        g.setColor(new Color(72,127,5));
        // 设置字体
        g.setFont(new Font("Splash", Font.PLAIN, 25));
        //常用的中国汉字
     ...
     * @return 随机字符
     */
    static private String createRandomChar(Graphics2D g, String baseChar) {
