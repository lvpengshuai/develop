                                ...
                                <div class="form-group height-div">
                                    ...
                                    <div>
                                        <input type="password" class="form-control oldpassword"
                                               placeholder="请填写原始密码" id="oldpassword" name="oldpassword" required=""
                                               aria-required="true">
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="form-group height-div">
                                    ...
                                    <div>
                                        <input type="password" class="form-control qpassword" id="qpassword"
                                               name="newpassword" placeholder="请再次填写密码" equalTo="#pwd" required/>
                                    </div>
                                </div>
                                <br>
                                <br>
                                ...
                                <div class="row" style="margin-bottom: 20px;margin-top: 20px;">
                                    <div class="col-md-4 col-sm-6">
                                        <div class="pull-right">
                                            <button class="btn btn-success" id="resetpassword_modal_btn_true" type="button" onclick="">完成
                                            </button>
                                        </div>
                                    </div>
                                </div>
...
<script src="${ctx}/static/admin/js/user/resetUserPassword.js"></script>
