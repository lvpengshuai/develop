            ...
            <div class="col-xlg-12 col-md-12">
                <div class="widget widget-shadow padding-bottom-5">
                    <div class="widget-content margin-10">
                        <%-- 表格功能按钮开始 --%>
                        <div class="form-group" id="periodical_table_toolbars" role="group">
                            <button type="button" class="btn btn-success btn-icon" id="btn-import">
                                <%--<i class="icon md-upload" aria-hidden="true"></i>--%> 导入zip
                            </button>
                            <button type="button" class="btn btn-success btn-icon" id="btn-publish" disabled>
                                <i class="icon fa-circle-o" aria-hidden="true"></i> 发布
                            </button>
                            <button type="button" class="btn btn-success btn-icon" id="btn-un-publish" disabled>
                                <i class="icon fa-ban" aria-hidden="true"></i> 撤销发布
                            </button>
                            <button id="btn-remove" type="button" class="btn btn-danger btn-icon" disabled>
                        ...
                        <%-- 表格功能按钮结束 --%>
                        <table id="periodical_table"></table>
                    </div>
                </div>
            </div>
        </div>
...
<script src="${ctx}/static/admin/js/periodical/periodical.js"></script>
