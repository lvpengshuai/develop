                    ...
                    <div class="widget-content margin-10">
                        ...
                        <div class="form-group" id="log_table_toolbars" role="group">
                            ...
                            <%--<div class="example-wrap">--%>
                                ...
                                <%--</div>--%>
                            <%--</div>--%>
                            <%--<div &lt;%&ndash;class="example-wrap"&ndash;%&gt;>--%>
                                <%--<div &lt;%&ndash;class="example"&ndash;%&gt;>--%>
                                    <%--<div class="input-daterange" id="datep" &lt;%&ndash;data-plugin="datepicker"&ndash;%&gt;>--%>
                                        <%--<div class="input-group">--%>
                                          <%--<span class="input-group-addon">--%>
                                            <%--<i class="icon md-calendar" aria-hidden="true"></i>--%>
                                          <%--</span>--%>
                                            <%--<input type="text" class="form-control" name="start" id="start" value="${start}" readonly="readonly" style="background-color: white"/>--%>
                                        <%--</div>--%>
                                        <%--<div class="input-group">--%>
                                            <%--<span class="input-group-addon">to</span>--%>
                                            <%--<input type="text" class="form-control" name="end" id="end" value="${ends}" readonly="readonly" style="background-color: white"/>--%>
                                        <%--</div>--%>
                                    <%--</div>--%>
                                <%--</div>--%>
                            <%--</div>--%>
...
<script src="${ctx}/static/admin/js/log/errorlog.js"></script>
