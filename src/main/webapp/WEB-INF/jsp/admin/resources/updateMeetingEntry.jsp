                ...
                <div class="widget widget-shadow">
                    <div class="widget-content margin-10">
                        <div class="panel-body">
                            <form action="${ctx}/admin/set/meetingEntry/submit" method="post">
                                ...
                                <div class="form-group"  style="width: 50%">
                                    <label>时间</label>
                                    <input type="text" class="form-control" placeholder="时间" value="<fmt:formatDate value="${bookDetails.exdate}" pattern="yyyy-MM-dd"/>" id="exdate" name="exdate">
                                </div>
                                <div class="form-group"  style="width: 50%">
                                    <label>地点</label>
                                    <input type="text" class="form-control" placeholder="地点" value="${bookDetails.exarea}" id="exarea" name="exarea">
                                </div>
                                <div class="form-group"  style="width: 50%">
                                    <label>会议描述</label>
                                    <textarea type="text" class="form-control" placeholder="会议描述" value="" id="htmlContent" rows="15" name="htmlContent"> ${bookDetails.htmlContent}</textarea>
                                </div>
                                <br>
