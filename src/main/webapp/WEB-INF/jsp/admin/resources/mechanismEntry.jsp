                ...
                <div class="widget widget-shadow padding-bottom-5">
                    <div class="widget-content margin-10">
                        ...
                        <div class="form-group" id="user_table_toolbars" role="group">
                            ...
                            <span class="page-size2" name="pageSize" id="pageSize">机构分类+机构名称+机构简介</span>
                            <span class="caret"/>
                            </button>
                            <ul class="dropdown-menu" id="userstate" role="menu">
                            <li class="active">
                            <a href="javascript:void(0)" value="1">机构分类+机构名称+机构简介</a>
                            </li>
                            <li>
                            <a href="javascript:void(0)" value="2">机构名称+机构简介</a>
                            </li>
                            <li>
                            <a href="javascript:void(0)" value="3">机构分类+机构名称</a>
                            </li>
                            </ul>
                            </span>
                            </span>
...
<script src="${ctx}/static/admin/js/resource/mechanismEntry.js"></script>
