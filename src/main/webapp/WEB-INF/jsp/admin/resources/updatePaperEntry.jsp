                ...
                <div class="widget widget-shadow">
                    <div class="widget-content margin-10">
                        <div class="panel-body" style="width: 50%;">
                            <form action="${ctx}/admin/set/paperEntry/submit" method="post">
                                ...
                                <div class="form-group">
                                    <label>作者（多个作者请用&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;进行分隔）</label>
                                    <input type="text" class="form-control" placeholder="作者" value=" ${bookDetails.people}" id="people" name="people">
                                </div>
                                <div class="form-group">
                                    <label>相关信息</label>
                                    <input type="text" class="form-control" placeholder="相关信息" value=" ${bookDetails.source}" id="source" name="source">
                                </div>
                                <br>
