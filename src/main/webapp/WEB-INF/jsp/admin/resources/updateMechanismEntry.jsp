                ...
                <div class="widget widget-shadow">
                    <div class="widget-content margin-10">
                        <div class="panel-body">
                            <form action="${ctx}/admin/set/mechanismEntry/submit" method="post">
                                <input type="hidden" value=" ${bookDetails.id}" name="id">
                                <input type="hidden" value=" ${bookDetails.bookcode}" name="bookcode">
                                <div class="form-group"  style="width: 50%">
                                    <label>机构分类</label>
                                    <input type="text" class="form-control" placeholder="机构分类" value="${bookDetails.title}" id="title_cn" name="title">
                                </div>
                                <div class="form-group"  style="width: 50%">
                                    <label>机构名称</label>
                                    <textarea type="text" rows="15" class="form-control" placeholder="机构名称" value="" id="htmlContent" name="htmlContent">${bookDetails.htmlContent}</textarea>
                                </div>
                                <div class="form-group"  style="width: 50%">
                                    <label>机构简介</label>
                                    <textarea type="text" rows="5" class="form-control" placeholder="机构简介" value="" id="abs" name="abs">${bookDetails.abs}</textarea>
                                </div>
                                <br>
