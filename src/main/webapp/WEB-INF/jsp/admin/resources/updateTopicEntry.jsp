                ...
                <div class="widget widget-shadow">
                    <div class="widget-content margin-10">
                        <div class="panel-body">
                            <form action="${ctx}/admin/set/topicEntry/submit" method="post">
                                ...
                                <c:if test="${bookDetails.source=='立项'}">
                                    <div class="form-group"  style="width: 50%">
                                        <label>编号</label>
                                        <input type="text" class="form-control" placeholder="编号" value=" ${exdataMap.编号}" name="编号">
                                    </div>
                                    <div class="form-group"  style="width: 50%">
                                        <label>负责人</label>
                                        <input type="text" class="form-control" placeholder="负责人" value=" ${exdataMap.负责人}" name="负责人">
                                    </div>
                                    <div class="form-group"  style="width: 50%">
                                        <label>职称</label>
                                        <input type="text" class="form-control" placeholder="职称" value=" ${exdataMap.职称}" name="职称">
                                    </div>
                                    <div class="form-group"  style="width: 50%">
                                        <label>机构</label>
                                        <input type="text" class="form-control" placeholder="机构" value=" ${exdataMap.机构}" name="机构">
                                    </div>
                                    <div class="form-group"  style="width: 50%">
                                        <label>资助金额</label>
                                        <input type="text" class="form-control" placeholder="资助金额" value=" ${exdataMap.资助金额}" name="资助金额">
                                    </div>
                                    <div class="form-group"  style="width: 50%">
                                        <label>立项资助</label>
                                        <input type="text" class="form-control" placeholder="立项资助" value=" ${exdataMap.立项资助}" name="立项资助">
                                    </div>
                                </c:if>
                                <c:if test="${bookDetails.source=='结项'}">
                                    <div class="form-group"  style="width: 50%">
                                        <label>编号</label>
                                        <input type="text" class="form-control" placeholder="编号" value=" ${exdataMap.编号}" name="编号">
                                    </div>
                                    ...
                                    <div class="form-group"  style="width: 50%">
                                        <label>单位</label>
                                        <input type="text" class="form-control" placeholder="单位" value=" ${exdataMap.单位}" name="单位">
                                    </div>
                                    <div class="form-group"  style="width: 50%">
                                        <label>成果形式</label>
                                        <input type="text" class="form-control" placeholder="成果形式" value=" ${exdataMap.成果形式}" name="成果形式">
                                    </div>
                                    <div class="form-group"  style="width: 50%">
                                        <label>成果名称</label>
                                        <input type="text" class="form-control" placeholder="成果名称" value=" ${exdataMap.成果名称}" name="成果名称">
                                    </div>
                                    <div class="form-group"  style="width: 50%">
                                        <label>评级</label>
                                        <input type="text" class="form-control" placeholder="评级" value=" ${exdataMap.评级}" name="评级">
                                    </div>
                                    <div class="form-group"  style="width: 50%">
                                        <label>立项时间</label>
                                        <input type="text" class="form-control" placeholder="立项时间" value=" ${exdataMap.立项时间}" name="立项时间">
                                    </div>
                                    <div class="form-group"  style="width: 50%">
                                        <label>立项资助</label>
                                        <input type="text" class="form-control" placeholder="立项资助" value=" ${exdataMap.立项资助}" name="立项资助">
                                    ...
                                    <div class="form-group"  style="width: 50%">
                                        <label>备注</label>
                                        <textarea type="text" class="form-control" placeholder="备注" name="备注" rows="5">${exdataMap.备注}</textarea>
                                    </div>
                                </c:if>
                                <br>
