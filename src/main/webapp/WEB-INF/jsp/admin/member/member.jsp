            ...
            <div class="col-xlg-12 col-md-12">
                <div class="widget widget-shadow padding-bottom-5">
                    <div class="widget-content margin-10">
                        <%-- 表格功能按钮开始 --%>
                        <div class="form-group" id="member_table_toolbars" role="group">
                            ...
                            <button type="button" class="btn btn-success btn-icon" id="btn_enable_user" disabled>
                                <i class="icon fa-check-circle" aria-hidden="true"></i> 启用
                            </button>
                            ...
                            <button type="button" class="btn btn-success btn-icon" id="btn_enable_user_attribute" disabled>
                                <i class="icon glyphicon glyphicon-user" aria-hidden="true"></i> 更改权限
                            </button>
                            <span class="page-list2">
                                <span class="btn-group dropdown">
                                    ...
                                    <ul class="dropdown-menu status-name" role="menu">
                                        <li class="active">
...
<script src="${ctx}/static/admin/js/member/member.js"></script>
