                        ...
                        <div class="panel-body">
                            <form id="addUser" method="post">
                                ...
                                <div class="form-group height-div">
                                    <label>教育程度</label>
                                    <div>
                                        <input type="text" class="form-control" placeholder="请填写教育程度" id="education" style="width: 50%;float: left;"
                                ...
                                <div class="form-group height-div">
                                    <label>职业</label>
                                    <div>
                                        <input type="text" class="form-control" placeholder="请填写职业" id="major" style="width: 50%;float: left;"
                                ...
                                <div class="form-group">
                                    <label>性别</label>
                                    <select class="form-control" id="gender" name="gender" onchange="" style="width:120px;">
...
<script src="${ctx}/static/admin/js/member/addmember.js"></script>
