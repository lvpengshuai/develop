                            ...
                            <span class="page-list2">
                                <span class="btn-group dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)" value="0">已审核</a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)" value="1">未审核</a>
                                        </li>
                                    </ul>
                                </span>
                            </span>
...
<script src="${ctx}/static/admin/js/knowledge/knowledgeReviewList.js"></script>
<script src="${ctx}/static/admin/js/knowledge/reviewInfo.js"></script>
<script>
