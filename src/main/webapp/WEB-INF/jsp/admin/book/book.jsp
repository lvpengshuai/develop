                ...
                <div class="widget widget-shadow padding-bottom-5">
                    <div class="widget-content margin-10">
                        ...
                        <div class="form-group" id="book_table_toolbars" role="group">
                            <div class="btn-group">
                                <button type="button" class="btn btn-success" id="btn-import">导入Zip</button>
                                <button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="caret"></span>
                                    <span class="sr-only">Toggle Dropdown</span>
                                </button>
                                <ul class="dropdown-menu">
                                    <li><a href="javascript:;" id="path-btn-import">指定文件目录</a></li>
                                </ul>
                            </div>
                            <%--<button type="button" class="btn btn-success btn-icon" id="btn-import">--%>
                                <%--<i class="icon md-upload" aria-hidden="true"></i> 导入--%>
                            <%--</button>--%>
                            ...
                            <button type="button" class="btn btn-success btn-icon" id="reference-documentation-import">参考文献处理</button>
...
<script src="${ctx}/static/remark/js/components/editable-table.min.js"></script>
<script src="${ctx}/static/remark/global/vendor/bootstrap-table/extensions/editable/bootstrap-table-editable.min.js"></script>
<script src="${ctx}/static/remark/global/vendor/x-editable/bootstrap-editable.min.js"></script>
<script src="${ctx}/static/admin/js/book/book.js"></script>
