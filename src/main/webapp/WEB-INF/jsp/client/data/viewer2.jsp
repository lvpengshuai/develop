...
<head>
    ...
    <link rel="stylesheet" href="../../../../static/client/pdf.js/viewer.css">


    <!-- This snippet is used in production (included from viewer.jsp) -->
    <link rel="resource" type="application/l10n" href="../../../../static/client/pdf.js/locale/locale.properties">
    <script src="../../../../static/client/js/jquery-1.11.3.min.js"></script>
    <script src="../../../../static/client/pdf.js/l10n.js"></script>
    <script src="../../../../static/client/pdf.js/pdf.js"></script>


    <script src="../../../../static/client/pdf.js/viewer2.js"></script>

    <script src="../../../../static/client/js/jquery.base64.js"></script>
    ...
    <div id="mainContainer">
        <div class="findbar hidden doorHanger" id="findbar">
            <div id="findbarInputContainer">
                <input id="findInput" class="toolbarField" title="Find" placeholder="Find in document鈥�" tabindex="91"
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
            <div id="secondaryToolbarButtonContainer">
                ...
                <button id="documentProperties" class="secondaryToolbarButton documentProperties"
                        title="Document Properties鈥�" tabindex="61" data-l10n-id="document_properties">
                ...
                <div id="toolbarViewer">
                    ...
                    <div id="toolbarViewerRight">
                        <button id="presentationMode" class="toolbarButton presentationMode hiddenLargeView"
                                title="Switch to Presentation Mode" tabindex="31" data-l10n-id="presentation_mode" style="display: none">
                            <span data-l10n-id="presentation_mode_label">Presentation Mode</span>
                        </button>
                        ...
                        <a href="#" id="viewBookmark" class="toolbarButton bookmark hiddenSmallView"
                           title="Current view (copy or open in new window)" tabindex="35" data-l10n-id="bookmark" style="display: none">
                            <span data-l10n-id="bookmark_label">Current View</span>
                        </a>
