        ...
        constructor: i, _events: [], _attachEvents: function () {
            ...
            if (o.length == 1) {
                ...
                switch (o[0].nodeName.toLowerCase()) {
                    ...
                    case"span":
                        if (!o.is(".disabled")) {
                            var q = this.viewDate.getUTCFullYear(), p = this.viewDate.getUTCMonth(), r = this.viewDate.getUTCDate(), s = this.viewDate.getUTCHours(), l = this.viewDate.getUTCMinutes(), t = new Date().getUTCSeconds();
                            if (o.is(".month")) {
