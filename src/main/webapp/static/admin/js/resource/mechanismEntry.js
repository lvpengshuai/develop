...
var UserManager = (function () {
    ...
    var option = {
        url: appPath + '/admin/get/mechanismEntry',
        dataType: 'json',
        cache: true,
        search: true,
        showRefresh: true,
    ...
    $('#remove-modal-btn-true').click(function () {
        ...
        $.ajax({
            url: appPath + '/admin/del/mechanismEntry/' + ids + '/' + bookCodes,
            dataType: 'json',
            type: 'get',
    ...
    window.operateEvents = {
        ...
        'click .edit': function (e, value, row) {
            ...
            window.location.href = appPath + '/admin/set/mechanismEntry/' + id + "/" + bookcode;
        },
    };
    ...
    $("#userstate li a").click(function () {
        ...
        var state = '';
        if ($this_val == '机构分类+机构名称+机构简介') {
            state = "1";
        } else if ($this_val == '机构名称+机构简介') {
            state = "2";
        } else if ($this_val == '机构分类+机构名称') {
            state = "3";
        }
        $('#state').val(state);
        $('#user_table').bootstrapTable("refresh");
