...
var UserManager = (function () {
    ...
    var option = {
        url: appPath + '/admin/get/meetingEntry',
        dataType: 'json',
        cache: true,
        search: true,
        showRefresh: true,
        ...
        columns: [{
            ...
            title: '会议描述',
            formatter:function (value) {
                var div="<div style='height: 65px;overflow: hidden;' title='"+value+"'>"+value+"</div>";
                return div;
            }
        }, {
            title: '操作',
    ...
    $('#remove-modal-btn-true').click(function () {
        ...
        $.ajax({
            url: appPath + '/admin/del/meetingEntry/' + ids + '/' + bookCodes,
            dataType: 'json',
            type: 'get',
    ...
    window.operateEvents = {
        ...
        'click .edit': function (e, value, row) {
            ...
            window.location.href = appPath + '/admin/set/meetingEntry/' + id + "/" + bookcode;
        },
    };
