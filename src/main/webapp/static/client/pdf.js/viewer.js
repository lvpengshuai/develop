...
/******/([
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        function configure(PDFJS) {
            PDFJS.imageResourcesPath = '../static/client/pdf.js/images/';
            PDFJS.workerSrc = '../static/client/pdf.js/pdf.worker.js';
            PDFJS.cMapUrl = '../static/client/pdf.js/cmaps/';
        ...
        var PDFViewerApplication = {
            ...
            setInitialView: function pdfViewSetInitialView(storedHash, options) {
                ...
                //     this.page = 1;
                // }
                this.pdfViewer.currentPageNumber=GetQueryString("page");
                var pagg = 1;
                if (GetQueryString("page") == null){
                    this.toolbar.setPageNumber(1, this.pdfViewer.currentPageLabel);
                }
                this.toolbar.setPageNumber(GetQueryString("page"), this.pdfViewer.currentPageLabel);
