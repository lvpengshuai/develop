...
var PDFViewerApplication = {
  ...
  setInitialView: function setInitialView(storedHash) {
    ...
    console.info(ddd+'----pppppp'+storedHash);
    ...
    //this.pdfViewer.currentPageNumber=40;
    var uuu=window.location.href;
    var len=uuu.length;
	var sffset=uuu.split("&");
	var nnn=uuu.substr(sffset,len);
	var sp=sffset[0].split("?");
	var vaaal=sp[1].split("=");
	var ddd=document.getElementById("pageNumber").value;
	//$("#pageNumber").value="2";
	//alert(ddd);
	var dddd=vaaal[1]
	console.info(dddd+'----pppppp'+ddd);
	if(ddd!=dddd)
	{
	...
	var b=("page="+dddd)
	this.pdfViewer.currentPageNumber=parseInt(dddd);
    console.info(dddd+'----pppppp'+storedHash);
